...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('store.blog')}}">
                @csrf
                <table class="mt-4 ml-4">
                    ...
                    <tr>
                        <td class="mt-3">
                        <input type="file" class="form-control" id="exampleFormControlFile1" name="image"></td>
                    ...
                    <tr>
                        <td><textarea id="editor" name="description"></textarea>
